...
Auf diese Weise wurden circa 10.000 Bilder gesammelt, die als Eingangsdaten für Modelle verwendet werden können.
...
\end{figure}
Dafür werden die Daten in die Annotationssoftware Doccano\footcite[\vglf][]{doccano-2018} geladen und dann den Kategorien zugeordnet. Der so gewonnene Export der Daten kann dann dafür verwendet werden die Bilder in gleichnamige Ordner zu verschieben.
