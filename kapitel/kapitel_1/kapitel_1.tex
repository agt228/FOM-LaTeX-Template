...
Die Evaluation der einzelnen Indikatoren wird in Form einer Tabelle dargestellt. Ein Beispiel ist am Ende dieses Kapitels aufgeführt (Abbildung~\ref{fig:mymuesli}).
...
Als Teilgebiet des Machine Learning bedient sich das Deep Learning mehrschichtiger neuronaler Netze, welche auf Basis großer Datenmengen bereits Erlerntes mit neuen Inhalten verknüpft und somit wiederum erneut lernt. \footcite[\vglf][\pagef2 \& 3]{plaat2022}
...
Bei der Image Classification handelt es sich um eine Technik, bei der ein Objekt auf einem Bild einer bestimmten Klasse zuordnet wird. Als Ziel kann die genaue Identifizierung der Bildmerkmale verstanden werden. \footcite[\vglf][\pagef2]{internationalconferenceoncomputercommunicationandinformatics2021}
Eine Methode, die zur Image Classification eingesetzt werden kann ist das \ac{CNN}~\footcite[\vglf][\pagef1]{internationalconferenceonadvancesinelectronics2018}, welches nachfolgend näher erläutert wird.

\subsubsection{Convolutional Neural Network}
Das \ac{CNN} ist eine besondere Form eines künstlichen neuronalen Netzes. Es zeichnet sich durch mehrere Schichten wie den Convolutional-Layer, den Pooling-Layer und den Fully-Connected Layer aus.~\footcite[\vglf][\pagef2]{internationalconferenceonadvancesinelectronics2018}
...
Die Verarbeitung dieser Merkmale erfolgt in Matrizen, die Feature Maps genannt werden.~\footcite[\vglf][\pagef327 \& 328]{Goodfellow-2016} \\
...
Die \acl{NER} hat zur Aufgabe automatisiert Entitäten in einem Textdokument zu finden und zu klassifizieren.~\footcite[\vglf][\pagef211]{kulkarni2022} Letzteres geschieht anhand zuvor definierter Kategorien.
