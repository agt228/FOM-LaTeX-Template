...
Anwendungsfälle können beispielsweise die Extraktion der Bedeutung von Sätzen oder Satzteilen oder auch die Erkennung von Satzzusammenhängen sein. \footcite[\vglf][\pagef 1 & 2]{deng2018} Die populärste Funktion des \ac{NLP} ist die Named Entity Recognition ( \acl{NER}). \footcite[\vglf][\pagef 299]{strobl2022}
...
\begin{flalign}
    F-Score{} {=} {}2 \cdot \frac{Precision \cdot Recall}{Precision + Recall} ~\footcite[\vglf][\pagef 105]{wang2021}
\end{flalign}
